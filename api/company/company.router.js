...
router.post("/company-to-stockiest", companyToStockiest);
router.post("/stockiest-from-company", stockestFromCompany);
router.post("/stockiest-to-company", stockiestToCompany);
router.post("/company-from-stockiest", companyFromStockiest);
router.post("/stockiest-details", getStockiestDetails);
